...
namespace controller {
    ...
    Input::NamedVector ActionsDevice::getAvailableInputs() const {
        static Input::NamedVector availableInputs {
            ...
            // Face Blendshapes
            makeAxisPair(Action::BROW_INNER_UP, "BrowInnerUp"),
            makeAxisPair(Action::BROW_DOWN_LEFT, "BrowDownLeft"),
            makeAxisPair(Action::BROW_DOWN_RIGHT, "BrowDownRight"),
            makeAxisPair(Action::BROW_OUTER_UP_LEFT, "BrowOuterUpLeft"),
            makeAxisPair(Action::BROW_OUTER_UP_RIGHT, "BrowOuterUpRight"),
            makeAxisPair(Action::EYE_LOOK_UP_LEFT, "EyeLookUpLeft"),
            makeAxisPair(Action::EYE_LOOK_UP_RIGHT, "EyeLookUpRight"),
            makeAxisPair(Action::EYE_LOOK_DOWN_LEFT, "EyeLookDownLeft"),
            makeAxisPair(Action::EYE_LOOK_DOWN_RIGHT, "EyeLookDownRight"),
            makeAxisPair(Action::EYE_LOOK_IN_LEFT, "EyeLookInLeft"),
            makeAxisPair(Action::EYE_LOOK_IN_RIGHT, "EyeLookInRight"),
            makeAxisPair(Action::EYE_LOOK_OUT_LEFT, "EyeLookOutLeft"),
            makeAxisPair(Action::EYE_LOOK_OUT_RIGHT, "EyeLookOutRight"),
            makeAxisPair(Action::EYE_BLINK_LEFT, "EyeBlinkLeft"),
            makeAxisPair(Action::EYE_BLINK_RIGHT, "EyeBlinkRight"),
            makeAxisPair(Action::EYE_SQUINT_LEFT, "EyeSquintLeft"),
            makeAxisPair(Action::EYE_SQUINT_RIGHT, "EyeSquintRight"),
            makeAxisPair(Action::EYE_WIDE_LEFT, "EyeWideLeft"),
            makeAxisPair(Action::EYE_WIDE_RIGHT, "EyeWideRight"),
            makeAxisPair(Action::CHEEK_PUFF, "CheekPuff"),
            makeAxisPair(Action::CHEEK_SQUINT_LEFT, "CheekSquintLeft"),
            makeAxisPair(Action::CHEEK_SQUINT_RIGHT, "CheekQuintRight"),
            makeAxisPair(Action::NOSE_SNEER_LEFT, "NoseSneerLeft"),
            makeAxisPair(Action::NOSE_SNEER_RIGHT, "NoseSneerRight"),
            makeAxisPair(Action::JAW_OPEN, "JawOpen"),
            makeAxisPair(Action::JAW_FORWARD, "JawForward"),
            makeAxisPair(Action::JAW_LEFT, "JawLeft"),
            makeAxisPair(Action::JAW_RIGHT, "JawRight"),
            makeAxisPair(Action::MOUTH_FUNNEL, "MouthFunnel"),
            makeAxisPair(Action::MOUTH_PUCKER, "MouthPucker"),
            makeAxisPair(Action::MOUTH_LEFT, "MouthLeft"),
            makeAxisPair(Action::MOUTH_RIGHT, "MouthRight"),
            makeAxisPair(Action::MOUTH_ROLL_UPPER, "MouthRollUpper"),
            makeAxisPair(Action::MOUTH_ROLL_LOWER, "MouthRollLower"),
            makeAxisPair(Action::MOUTH_SHRUG_UPPER, "MouthShrugUpper"),
            makeAxisPair(Action::MOUTH_SHRUG_LOWER, "MouthShrugLower"),
            makeAxisPair(Action::MOUTH_CLOSE, "MouthClose"),
            makeAxisPair(Action::MOUTH_SMILE_LEFT, "MouthSmileLeft"),
            makeAxisPair(Action::MOUTH_SMILE_RIGHT, "MouthSmileRight"),
            makeAxisPair(Action::MOUTH_FROWN_LEFT, "MouthFrownLeft"),
            makeAxisPair(Action::MOUTH_FROWN_RIGHT, "MouthFrownRight"),
            makeAxisPair(Action::MOUTH_DIMPLE_LEFT, "MouthDimpleLeft"),
            makeAxisPair(Action::MOUTH_DIMPLE_RIGHT, "MouthDimpleRight"),
            makeAxisPair(Action::MOUTH_UPPER_UP_LEFT, "MouthUpperUpLeft"),
            makeAxisPair(Action::MOUTH_UPPER_UP_RIGHT, "MouthUpperUpRight"),
            makeAxisPair(Action::MOUTH_LOWER_DOWN_LEFT, "MouthLowerDownLeft"),
            makeAxisPair(Action::MOUTH_LOWER_DOWN_RIGHT, "MOuthLowerDownRight"),
            makeAxisPair(Action::MOUTH_PRESS_LEFT, "MouthPressLeft"),
            makeAxisPair(Action::MOUTH_PRESS_RIGHT, "MouthPressRight"),
            makeAxisPair(Action::MOUTH_STRETCH_LEFT, "MouthStretchLeft"),
            makeAxisPair(Action::MOUTH_STRETCH_RIGHT, "MouthStretchRight"),
            makeAxisPair(Action::TONGUE_OUT, "TongueOut"),
