...
Input::NamedVector StandardController::getAvailableInputs() const {
    static Input::NamedVector availableInputs {
        ...
        // Face Blendshapes
        makePair(BROW_INNER_UP, "BrowInnerUp"),
        makePair(BROW_DOWN_LEFT, "BrowDownLeft"),
        makePair(BROW_DOWN_RIGHT, "BrowDownRight"),
        makePair(BROW_OUTER_UP_LEFT, "BrowOuterUpLeft"),
        makePair(BROW_OUTER_UP_RIGHT, "BrowOuterUpRight"),
        makePair(EYE_LOOK_UP_LEFT, "EyeLookUpLeft"),
        makePair(EYE_LOOK_UP_RIGHT, "EyeLookUpRight"),
        makePair(EYE_LOOK_DOWN_LEFT, "EyeLookDownLeft"),
        makePair(EYE_LOOK_DOWN_RIGHT, "EyeLookDownRight"),
        makePair(EYE_LOOK_IN_LEFT, "EyeLookInLeft"),
        makePair(EYE_LOOK_IN_RIGHT, "EyeLookInRight"),
        makePair(EYE_LOOK_OUT_LEFT, "EyeLookOutLeft"),
        makePair(EYE_LOOK_OUT_RIGHT, "EyeLookOutRight"),
        makePair(EYE_BLINK_LEFT, "EyeBlinkLeft"),
        makePair(EYE_BLINK_RIGHT, "EyeBlinkRight"),
        makePair(EYE_SQUINT_LEFT, "EyeSquintLeft"),
        makePair(EYE_SQUINT_RIGHT, "EyeSquintRight"),
        makePair(EYE_WIDE_LEFT, "EyeWideLeft"),
        makePair(EYE_WIDE_RIGHT, "EyeWideRight"),
        makePair(CHEEK_PUFF, "CheekPuff"),
        makePair(CHEEK_SQUINT_LEFT, "CheekSquintLeft"),
        makePair(CHEEK_SQUINT_RIGHT, "CheekQuintRight"),
        makePair(NOSE_SNEER_LEFT, "NoseSneerLeft"),
        makePair(NOSE_SNEER_RIGHT, "NoseSneerRight"),
        makePair(JAW_OPEN, "JawOpen"),
        makePair(JAW_FORWARD, "JawForward"),
        makePair(JAW_LEFT, "JawLeft"),
        makePair(JAW_RIGHT, "JawRight"),
        makePair(MOUTH_FUNNEL, "MouthFunnel"),
        makePair(MOUTH_PUCKER, "MouthPucker"),
        makePair(MOUTH_LEFT, "MouthLeft"),
        makePair(MOUTH_RIGHT, "MouthRight"),
        makePair(MOUTH_ROLL_UPPER, "MouthRollUpper"),
        makePair(MOUTH_ROLL_LOWER, "MouthRollLower"),
        makePair(MOUTH_SHRUG_UPPER, "MouthShrugUpper"),
        makePair(MOUTH_SHRUG_LOWER, "MouthShrugLower"),
        makePair(MOUTH_CLOSE, "MouthClose"),
        makePair(MOUTH_SMILE_LEFT, "MouthSmileLeft"),
        makePair(MOUTH_SMILE_RIGHT, "MouthSmileRight"),
        makePair(MOUTH_FROWN_LEFT, "MouthFrownLeft"),
        makePair(MOUTH_FROWN_RIGHT, "MouthFrownRight"),
        makePair(MOUTH_DIMPLE_LEFT, "MouthDimpleLeft"),
        makePair(MOUTH_DIMPLE_RIGHT, "MouthDimpleRight"),
        makePair(MOUTH_UPPER_UP_LEFT, "MouthUpperUpLeft"),
        makePair(MOUTH_UPPER_UP_RIGHT, "MouthUpperUpRight"),
        makePair(MOUTH_LOWER_DOWN_LEFT, "MouthLowerDownLeft"),
        makePair(MOUTH_LOWER_DOWN_RIGHT, "MOuthLowerDownRight"),
        makePair(MOUTH_PRESS_LEFT, "MouthPressLeft"),
        makePair(MOUTH_PRESS_RIGHT, "MouthPressRight"),
        makePair(MOUTH_STRETCH_LEFT, "MouthStretchLeft"),
        makePair(MOUTH_STRETCH_RIGHT, "MouthStretchRight"),
        makePair(TONGUE_OUT, "TongueOut"),
