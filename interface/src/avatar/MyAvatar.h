...
public:
    ...
    Q_INVOKABLE bool getHMDComfortModeEnabled() const { return _hmdComfortModeEnabled; }
    Q_INVOKABLE void setHMDComfortModeEnabled(bool enabled);
    ...
    glm::vec3 getVelocityForAnimation() const;
